...
'''
입력 4개:sepal_length, sepal_width, petal_length, petal_width, species
 .....>> 
 출력 3가지 : setosa, versicolor, virginica
'''
...
'''
input(x1~x4 4개) -> 뉴런 10개 -> output(3개)
'''

# 모델 구축
model.compile(
    # 3가지이상이 나오므로 categorical_ 사용
